...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" integrity="sha384-QJHtvGhmr9XOIpI6YVutG+2QOK9T+ZnN4kzFN1RtK3zEFEIsxhlmWl5/YESvpZ13" crossorigin="anonymous"></script>
  <body class="bg-black-100 text-white-800">
    ...
    <nav class="h-16 flex justify-end py-4 px-16">
        ...
        <a href="{{route('alumnos.index')}}"class="text-black rounded px-4 pt-1 h-10 font-semibold mx-2 ">Regresar</a>

        <a href="{{route('alumnos.create')}}" class="text-black rounded px-4 pt-1 h-10 font-semibold mx-2 ">Crear</a>
